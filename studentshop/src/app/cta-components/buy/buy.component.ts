...
@Component({
  ...
  styleUrls: ['../cta-components.css', './buy.component.css']
})
export class BuyComponent {
  ...
  setTitleAndMetaTags() {
    const titleContent = `${this.subject || 'High school'} notes`;
    const descriptionContent = `Browse ${this.subject || 'high school'} study notes. Discover high
    quality notes by subject and year to help you prepare for exams.`;
